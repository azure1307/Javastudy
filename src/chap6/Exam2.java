package chap6;
/*
 * 구동 클래스를 실행시 다음과 같은 결과가 나오도록 Rectangle3 클래스 구현하기
 * Rectangle3 클래스
 *  멤버변수: width(가로), height(세로), sno(사각형생성번호), cnt(생성번호를 위한 static 변수)
 *  생성자: 구동클래스에 맞도록 구현
 *  멤버메서드: area(): 넓이 값 리턴
 *          length(): 둘레 값 리턴
...
public class Exam2 {
	public static void main(String[] args) {
		...
		Rectangle3 r2 = new Rectangle3(30,40);
